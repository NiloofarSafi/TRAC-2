...
This package contains two files
	- trac2_iben_train.csv 
	- trac2_iben_dev.csv 

'trac2_iben_train.csv' contains the train set for the shared task in Indian Bangla. 
'trac2_iben_dev.csv' contains data for selecting and testing the model such that they do not overfit for the train set.
